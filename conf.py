...
import os
import sys
sys.path.insert(0, r'/media/aminya/Linux/GitHub/Cpp/project_options/docs')
...
templates_path = ['/media/aminya/Linux/GitHub/Cpp/project_options/docs/templates']
...
# html_static_path = ['/media/aminya/Linux/GitHub/Cpp/project_options/docs/static']
...
breathe_projects = {
	'C++ Sphinx Doxygen Breathe': "/media/aminya/Linux/GitHub/Cpp/project_options/docs/build/xml/"
}

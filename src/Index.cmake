...
include("${ProjectOptions_SRC_DIR}/LibFuzzer.cmake")
...
macro(project_options)
  ...
  if(ProjectOptions_ENABLE_SANITIZER_UNDEFINED_BEHAVIOR)
    if(ProjectOptions_ENABLE_SANITIZER_UNDEFINED)
      message(
        WARNING
          "Don't switch on both ENABLE_SANITIZER_UNDEFINED_BEHAVIOR and ENABLE_SANITIZER_UNDEFINED. Use ENABLE_SANITIZER_UNDEFINED only."
      )
    else()
      message(
        DEPRECATION
          "ENABLE_SANITIZER_UNDEFINED_BEHAVIOR is deprecated. Use ENABLE_SANITIZER_UNDEFINED instead."
      )
    endif()
